...
```console
helm install stable/isitup-dashboard
```
...
```console
helm install stable/isitup-dashboard --name my-release
```

The command deploys isitup-dashboard on the Kubernetes cluster in the default configuration. The [configuration](#configuration) section lists the parameters that can be configured during installation.
...
The following table lists the configurable parameters of the isitup-dashboard chart and their default values.

| Parameter                           | Description                                                                                                                 | Default                                                                    |
|-------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
| `image.repository`                  | Repository for container image                                                                                              | `k8s.gcr.io/isitup-dashboard-amd64`                                    |
...
```console
helm install stable/isitup-dashboard --name my-release -f values.yaml
```
...
- `http://localhost:8001/api/v1/namespaces/kube-system/services/https:isitup-dashboard:https/proxy/` or
- `http://localhost:8001/api/v1/namespaces/kube-system/services/http:isitup-dashboard:http/proxy/` if `enableInsecureLogin=true`

For this to reach the dashboard, the name of the service must be 'isitup-dashboard', not any other value as set by Helm. You can manually specify this using the value 'fullnameOverride':

```
fullnameOverride: 'isitup-dashboard'
```
